...
export default function EmergencyPage({ service }: PageProps) {
            ...
            <div className="mx-auto w-full max-w-[1272px] px-4">
              <div className="flex justify-center">
                <div className="inline-flex flex-col items-center gap-2 mb-4 w-fit">
                  <span className="text-black text-xs sm:text-sm font-semibold tracking-wide">{service.slug.toUpperCase()}</span>
...
export async function getStaticProps() {
  ...
  try {
    ...
    service = { slug, title: 'Layanan Gawat Darurat', description: 'Konten belum tersedia.', sections: [] };
  }
